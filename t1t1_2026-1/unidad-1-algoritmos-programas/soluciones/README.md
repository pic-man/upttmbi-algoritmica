# 💻 Soluciones de Estudiantes - Unidad 1

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 1: Algoritmo y Programas.
...
```bash
cd unidad-1-algoritmos-programas/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-1-algoritmos-programas",
...
```bash
git add .
git commit -m "[Unidad-1] Agregar ejercicio 1"
