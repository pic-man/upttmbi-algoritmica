# 💻 Soluciones de Estudiantes - Unidad 3

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 3: Datos y Entidades Primitivas.
...
```bash
cd unidad-3-datos-entidades-primitivas/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-3-datos-entidades-primitivas",
...
```bash
git add .
git commit -m "[Unidad-3] Agregar ejercicio 1"
