# 💻 Soluciones de Estudiantes - Unidad 5

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 5: Programación Estructurada.
...
```bash
cd unidad-5-programacion-estructurada/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-5-programacion-estructurada",
...
```bash
git add .
git commit -m "[Unidad-5] Agregar ejercicio 1"
