# 💻 Soluciones de Estudiantes - Unidad 6

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 6: Programación Modular.
...
```bash
cd unidad-6-programacion-modular/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-6-programacion-modular",
...
```bash
git add .
git commit -m "[Unidad-6] Agregar ejercicio 1"
