# 💻 Soluciones de Estudiantes - Unidad 7

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 7: Técnicas de Mantenimiento.
...
```bash
cd unidad-7-mantenimiento-programas/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-7-mantenimiento-programas",
...
```bash
git add .
git commit -m "[Unidad-7] Agregar ejercicio 1"
