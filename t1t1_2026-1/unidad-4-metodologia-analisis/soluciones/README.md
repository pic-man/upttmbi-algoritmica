# 💻 Soluciones de Estudiantes - Unidad 4

## 📁 Carpeta de Entregas

Esta carpeta contiene las soluciones de todos los estudiantes para la Unidad 4: Metodología para el Análisis.
...
```bash
cd unidad-4-metodologia-analisis/soluciones/
...
cat > info.json << 'EOF'
{
  ...
  "cedula": "V-12345678",
  "seccion": "TU-SECCION",
  "unidad": "unidad-4-metodologia-analisis",
...
```bash
git add .
git commit -m "[Unidad-4] Agregar ejercicio 1"
